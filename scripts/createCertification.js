...
const mockCert = {
  candidateName: encrypt("Aayush Verma", "5c0157fd3ff47a2a54075b01"),
  rollNo: encrypt("LIT2020053", "5c0157fd3ff47a2a54075b01"),
...
module.exports = async function (callback) {
  // Set Up
  console.log(
    chalk.blue("==== Connecting to deployed Institution Contract ====")
  );
  ...
  console.log(
    chalk.blue("==== Connecting to deployed Certification Contract ====")
  );
  ...
  try {
    ...
    console.log(
      chalk.bgRed("Something went wrong, check error message below:")
    );
    console.log(err);
  }
  callback();
